...
class LoraGroundingDINO(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.backbone = get_peft_model(self.backbone, backbone_config)
        self.backbone.print_trainable_parameters()
        self.backbone = self.backbone.base_model.model # remove prefix 
        
        encoder_config = LoraConfig(
            r=16,
            lora_alpha=16,
            target_modules=["v_proj", "l_proj", "values_v_proj", "values_l_proj", "value_proj"],
            lora_dropout=0.1,
            bias="none",
        )
        self.encoder = get_peft_model(self.encoder, encoder_config)
        self.encoder.print_trainable_parameters()
        self.encoder = self.encoder.base_model.model # remove prefix 
        ...
        self.decoder = get_peft_model(self.decoder, decoder_config)
        self.decoder.print_trainable_parameters()
        self.decoder = self.decoder.base_model.model # remove prefix 
        ...
        self.text_feat_map = nn.Linear(
            ...
            bias=True)
        # lora language_model
        language_model_config = LoraConfig(
            r=16,
            lora_alpha=16,
        ...
        self.language_model = get_peft_model(self.language_model, language_model_config)
        self.language_model.print_trainable_parameters()
        self.language_model = self.language_model.base_model.model # remove prefix 
