...
from ..layers.transformer.adapter_grounding_dino_layers import (
    AdapterGroundingDinoTransformerDecoder, AdapterGroundingDinoTransformerEncoder)
...
class AdapterGroundingDINO(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = AdapterGroundingDinoTransformerEncoder(**self.encoder)
        self.decoder = AdapterGroundingDinoTransformerDecoder(**self.decoder)
