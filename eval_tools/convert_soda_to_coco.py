...
label_ids = {name: i+1 for i, name in enumerate(soda_classes)}
...
def cvt_to_coco_json(annotations):
    ...
    for category_id, name in enumerate(soda_classes):
        category_item = dict()
    ...
    for ann_dict in annotations:
        ...
        image_id = int(image_id.split("_")[2] + image_id.split("_")[-1])
